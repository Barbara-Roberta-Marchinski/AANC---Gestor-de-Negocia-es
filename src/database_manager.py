...
def carregar_dataset():
    ...
    # Atenção aqui: o caminho precisa ser o do arquivo que você baixou!
    caminho_arquivo = '../data/ibm_attrition.csv'
...
def treinar_modelo(X_train, y_train, preprocessor):
    ...
    # Criar pipeline final que aplica o pré-processamento e o modelo AutoML
    ...
    pipeline_final.named_steps['preprocessamento'].fit(X_train)

    return pipeline_final, automl
...
def salvar_modelo(pipeline, caminho='modelo_turnover.pkl'):
...
if __name__ == '__main__':
    ...
    pipeline, automl = treinar_modelo(X_train, y_train, preprocessor)
